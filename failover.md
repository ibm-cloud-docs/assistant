...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Failover options](/docs/watson-assistant?topic=watson-assistant-admin-failover){: external}
{: attention}
