...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Dialog skill analytics overview](/docs/watson-assistant?topic=watson-assistant-logs-overview){: external}.
{: attention}
