...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Improving your dialog skill](/docs/watson-assistant?topic=watson-assistant-logs){: external}.
{: attention}
