...
When you open the *Improve* tab, metrics are shown that were generated by user interactions with the current dialog skill. No mertics are shown if the current skill has not been deployed and used by customers.
