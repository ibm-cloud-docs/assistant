...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Currency support](/docs/watson-assistant?topic=watson-assistant-sys-currency-details){: external}.
{: attention}
