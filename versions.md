...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Managing workflow with versions](/docs/watson-assistant?topic=watson-assistant-versions){: external}.
{: attention}
...
The number of versions you can create for a single skill depends on your {{site.data.keyword.assistant_classic_short}} plan.
