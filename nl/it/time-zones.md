...
# Fusi orari supportati dalle entità di sistema
{: #time-zones}

Questo elenco di fusi orari supportati può essere utilizzato con le funzioni di fuso orario correlate alle [entità @sys-date e @sys-time](/docs/services/assistant?topic=assistant-system-entities#system-entities-sys-date-time).
{: shortdesc}
...
|         Canada/Pacifico         |        Canada/Saskatchewan       |
...
|          Pacifico/Palau         |         Pacifico/Pitcairn         |
|         Pacifico/Pohnpei        |          Pacifico/Ponape          |
|      Pacifico/Port_Moresby      |         Pacifico/Rarotonga        |
|         Pacifico/Saipan         |           Pacifico/Samoa          |
