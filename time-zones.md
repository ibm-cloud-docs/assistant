...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Time zones supported by system entities](/docs/watson-assistant?topic=watson-assistant-time-zones){: external}.
{: attention}
