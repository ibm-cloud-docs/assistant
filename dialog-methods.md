...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Expression language methods for dialog](/docs/watson-assistant?topic=watson-assistant-dialog-methods){: external}.
{: attention}
