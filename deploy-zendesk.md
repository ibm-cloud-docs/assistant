...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Integrating with Zendesk](/docs/watson-assistant?topic=watson-assistant-deploy-zendesk){: external}.
{: attention}
