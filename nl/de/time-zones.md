...
# Von Systementitäten unterstützte Zeitzonen
{: #time-zones}

Die Liste der unterstützten Zeitzonen in diesem Abschnitt kann bei den Zeitzonenfunktionen verwendet werden, die sich auf die [Entitäten '@sys-date' und '@sys-time'](/docs/services/assistant?topic=assistant-system-entities#system-entities-sys-date-time) beziehen.
{: shortdesc}
