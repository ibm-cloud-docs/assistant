...
Intercom is a customer service messaging platform that evaluates user support inquiries and transfers them to the best human agent or team of agents to address the user's question or request.
{: shortdesc}
