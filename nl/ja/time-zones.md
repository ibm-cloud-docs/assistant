...
サポートされるタイム・ゾーンのこのリストは、[@sys-date および @sys-time の各エンティティー](/docs/services/assistant?topic=assistant-system-entities#system-entities-sys-date-time)に関連したタイム・ゾーン関数で使用することができます。
{: shortdesc}
