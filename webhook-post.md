...
The following sample shows how a simple request body is formatted. The event name `message_processed` indicates that the request is generated by the postmessage webhook.
