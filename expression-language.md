...
You can use any of the [String methods](/docs/services/conversation/dialog-methods.html#dialog-methods-strings) to evaluate or manipulate text from the user input. For example:
