...
# Intégration à Intercom ![Forfait Plus ou Premium uniquement](images/plus.png)
{: #deploy-intercom}
...
Cette intégration est disponible uniquement pour les utilisateurs du forfait Plus ou Premium. Si vous souhaitez la réaliser, vous pouvez vous inscrire à un forfait Plus Trial gratuit. [Obtenez le forfait Plus Trial](https://cloud.ibm.com/registration?target=%2Fdeveloper%2Fwatson%2Flaunch-tool%2Fconversation%3Fplan%3Dplus-trial&cm_mmc=OSocial_Voicestorm-_-Watson+AI_Watson+Core+-+Conversation-_-WW_WW-_-Intercom+Trial+Registration+Link&cm_mmca1=000027BD&cm_mmca2=10004432).
{: note}
...
Si vous ne disposez pas d'une compétence de dialogue associée à votre assistant, créez-en une ou ajoutez-en une à votre assistant maintenant. Pour plus d'informations, reportez-vous à la rubrique [Création d'un dialogue](/docs/services/assistant?topic=assistant-dialog-build).

Le déclenchement d'une recherche via une compétence de recherche n'est actuellement pas pris en charge par une intégration Intercom.
{: note}
...
1.  Préparez chaque branche de dialogue à déclencher par l’assistant à partir de l’application Intercom.
    ...
    - **External node name** : ajoutez un résumé de l'objectif de la branche de dialogue. Par exemple, *Trouver un magasin*.
      ...
      **N'ajoutez pas** de nom de noeud externe au noeud racine que vous avez créé à l'étape 2. En cas d'escalade, l'assistant examine le nom du noeud externe du dernier noeud traité pour savoir quel objectif utilisateur n'a pas été atteint. Si vous incluez un nom de noeud externe dans le noeud avec l'intention de connexion à un agent humain, vous empêcherez l'assistant d'apprendre le dernier noeud réel axé sur les objectifs avec lequel l'utilisateur a interagi avant de faire remonter le problème.
      {: tip}
...
La vidéo suivante de 4 minutes illustre les étapes. 

<iframe class="embed-responsive-item" id="youtubeplayer" title="Configuration rapide" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/SkbFWNScueU" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>
...
Les agents humains peuvent attribuer des messages à l'assistant à l'aide des règles d'attribution d'Intercom. Les messages peuvent être affectés à l'assistant de la manière suivante :

- Affectation automatique des conversations entrantes à une boîte de réception d'un équipier ou d'une équipe en fonction de certains critères 

  La vidéo suivante d'1,5 minute illustre les étapes. 

  <iframe class="embed-responsive-item" id="youtubeplayer2" title="Affectation automatique" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/4M9wu8NHxcY" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>

- Réaffectation manuelle effectuée par un agent humain lors de l'exécution.

  La vidéo suivante de moins de 3 minutes illustre les étapes. 

  <iframe class="embed-responsive-item" id="youtubeplayer3" title="Affectation manuelle" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/jAnolyUJAIA" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>

Pour plus d'informations, reportez-vous à la [documentation Intercom ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://www.intercom.com/help/support-and-retain-customers/work-as-a-team/assign-conversations-to-teammates-and-teams).
...
1.  Cliquez sur **Access Intercom** pour être redirigé vers le site Intercom.
     ...
     Connectez-vous à Intercom en utilisant l’adresse électronique et du mot de passe fonctionnels de l’assistant, et non des vôtres. Vous souhaitez établir la connexion à un ID fonctionnel partagé par plusieurs personnes de votre organisation.
     {: important}
...
La vidéo suivante de 3 minutes illustre les étapes.

<iframe class="embed-responsive-item" id="youtubeplayer0" title="Routage d'escalade basé sur un sujet" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/dTwJZOqdzII" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>
...
<iframe class="embed-responsive-item" id="youtubeplayer1" title="Surveillance de la boîte de réception" type="text/html" width="640" height="390" src="https://www.youtube.com/embed/fFKjWUfIftw" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen> </iframe>
