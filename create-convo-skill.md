...
The conversational skill cannot interact with customers until it is added to an assistant and the assistant is deployed. You must open the assistant tile and add the skill to the assistant from the assistant configuration page; you cannot pick an assistant to add the skill to from the skill configuration page. One skill can be used by more than one assistant.
