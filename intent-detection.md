...
**Algorithms versions** allows you to choose which version of {{site.data.keyword.assistant_classic_short}} algorithms to apply to your future trainings.
{: shortdesc}
...
The baseline and beta versions are labeled with dates such as **Baseline (2022-06-01)** or **Beta (2022-06-10)**. This refers to the release of a specific baseline or beta version. You can consult the [release notes](/docs/watson-assistant?topic=watson-assistant-watson-assistant-release-notes){: external} for details of updates made in that algorithms version release.
