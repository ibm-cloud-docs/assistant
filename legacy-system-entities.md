...
### Recognized formats
{: #legacy-system-entities-sys-currency-formats}
...
### Metadata
{: #legacy-system-entities-sys-currency-metadata}
...
### Returns
{: #legacy-system-entities-sys-currency-returns}
...
{: #legacy-system-entities-currencty-usage-tips}
...
- Currency values are recognized as instances of @sys-number entities as well. If you are using separate conditions to check for both currency values and numbers, place the condition that checks for currency before the one that checks for a number.
  ...
  This workaround is not necessary if you are using the revised system entities. For more information, see [New system entities](/docs/assistant?topic=assistant-system-entities).
  {: note}
...
{: #legacy-system-entities-sys-date-time}
...
### Date-time mentions
{: #legacy-system-entities-date-time-mentions}
...
{: #legacy-system-entities-date-time-ranges}
...
{: #legacy-system-entities-last-next}
...
### Time zones
{: #legacy-system-entities-time-zones}
...
{: #legacy-system-entities-time-zone-examples}
...
### Recognized formats
{: #legacy-system-entities-sys-date-time-formats}
...
### Returns
{: #legacy-system-entities-sys-date-time-returns}
...
### Recognized formats
{: #legacy-system-entities-sys-number-formats}
...
### Metadata
{: #legacy-system-entities-sys-number-metadata}

- `.numeric_value` - the canonical numeric value as an integer or a double

### Returns
{: #legacy-system-entities-sys-number-returns}
...
{: #legacy-system-entities-sys-number-usage-tips}
...
{: #legacy-system-entities-sys-percentage}
...
### Recognized formats
{: #legacy-system-entities-sys-percentage-formats}

- 15%
- 10 percent

### Metadata
{: #legacy-system-entities-sys-percentage-metadata}

`.numeric_value`: the canonical numeric value as an integer or a double

### Returns
{: #legacy-system-entities-sys-percentage-returns}
...
{: #legacy-system-entities-sys-percentage-usage-tips}
