...
Documentation for the **classic {{site.data.keyword.assistant_classic_short}}** experience has moved. For the most up-to-date version, see [Handling SMS with Twilio interactions](/docs/watson-assistant?topic=watson-assistant-dialog-sms-actions){: external}.
{: attention}
